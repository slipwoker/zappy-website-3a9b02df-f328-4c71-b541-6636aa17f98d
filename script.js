    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ירון קוטיק אדריכלים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3a9b02df-f328-4c71-b541-6636aa17f98d',
                    name: data.name || '',
                    email: data.email || '',
